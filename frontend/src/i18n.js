...
const resources = {
  AR: {
    translation: {
      ...
      Cart: 'Carrito',
      'Log out': 'Salir',
      'Enter an amount': 'Ingresar un monto',
      'The credit was deposited': 'El credito fue depositado',
      'Credit to deposit': 'Credito a depositar',
      'Your balance is': 'Su saldo es de',
      'Charge credit': 'Cargar credito',
